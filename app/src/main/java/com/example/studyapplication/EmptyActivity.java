...
/**
 * 空白测试
 * 在androidmanifest.xml指定主页面layout
 *
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view,"delete",Snackbar.LENGTH_SHORT)
                    ...
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(EmptyActivity.this,"确认",Toast.LENGTH_SHORT).show();
                    }
                }).show();

                //Toast.makeText(EmptyActivity.this,"悬浮点击内容",Toast.LENGTH_SHORT).show();
